...
void gpio_for_w5500_config(void)
{
  ...
  /*!< 设置引脚复用 */
  GPIO_PinAFConfig(WIZ_SPIx_SCLK_GPIO_PORT,WIZ_SPIx_SCLK_PINSOURCE,WIZ_SPIx_SCLK_AF); 
  GPIO_PinAFConfig(WIZ_SPIx_MISO_GPIO_PORT,WIZ_SPIx_MISO_PINSOURCE,WIZ_SPIx_MISO_AF); 
  GPIO_PinAFConfig(WIZ_SPIx_MOSI_GPIO_PORT,WIZ_SPIx_MOSI_PINSOURCE,WIZ_SPIx_MOSI_AF); 
    
  /*!< 配置SPI_FLASH_SPI引脚: SCK */
  ...
  SPI_InitStructure.SPI_DataSize = SPI_DataSize_8b;                     /* 设置 SPI 的数据帧长度，可选 8/16 位 */
  SPI_InitStructure.SPI_CPOL = SPI_CPOL_High;                           /* 设置时钟极性 CPOL，可选高/低电平 */
  SPI_InitStructure.SPI_CPHA = SPI_CPHA_2Edge;                          /* 设置时钟相位，可选奇/偶数边沿采样 */
  ...
  SPI_InitStructure.SPI_CRCPolynomial = 7;                              /* 设置 CRC 校验的表达式 */
