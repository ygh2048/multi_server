...
#define WIZ_SPIx_GPIO_CLK       RCC_AHB1Periph_GPIOB	  	 /* GPIO端口时钟                 */
...
#define WIZ_SPIx_SCLK_GPIO_PORT             GPIOB
#define WIZ_SPIx_SCLK_PINSOURCE             GPIO_PinSource13
#define WIZ_SPIx_SCLK_AF                    GPIO_AF_SPI2

#define WIZ_SPIx_MISO           GPIO_Pin_14					 /* 定义W5500的MISO管脚          */
#define WIZ_SPIx_MISO_GPIO_PORT             GPIOB
#define WIZ_SPIx_MISO_PINSOURCE             GPIO_PinSource14
#define WIZ_SPIx_MISO_AF                    GPIO_AF_SPI2

#define WIZ_SPIx_MOSI           GPIO_Pin_15					 /* 定义W5500的MOSI管脚          */
#define WIZ_SPIx_MOSI_GPIO_PORT             GPIOB
#define WIZ_SPIx_MOSI_PINSOURCE             GPIO_PinSource15
#define WIZ_SPIx_MOSI_AF                    GPIO_AF_SPI2
...
#define WIZ_SPIx_SCS_CLK      RCC_AHB1Periph_GPIOB	 	  /* GPIO端口时钟                 */
